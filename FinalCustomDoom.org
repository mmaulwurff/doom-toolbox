...
#include "zscript/PlainTranslator.zs"
#+end_src

[[file:modules/PlainTranslator.org][PlainTranslator]]

#+begin_src c :tangle build/FinalCustomDoom/zscript/PlainTranslator.zs
<<module("PlainTranslator")>>
#+end_src

#+name: module
#+begin_src elisp :var module-name = "" :exports none
(mapconcat #'identity (process-lines "python"
  "./tools/org.py" "export" (format "modules/%s.org" module-name) "cd_") "\n")
#+end_src
...
#+begin_src text :tangle build/FinalCustomDoomTestCommands.txt
