...
* Project files :noexport:

#+name: copy-files
#+begin_src elisp :exports none
(copy-directory "LICENSES" "build/DoomDoctor/LICENSES" nil t t)
(copy-directory "documentation" "build/DoomDoctor/documentation" nil t t)
(copy-file "DoomDoctor.org" "build/DoomDoctor/Readme.org" t)
#+end_src
