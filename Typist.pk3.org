...
#+begin_src c :tangle build/Typist.pk3/zscript/player_handler/tt_player_handler.zs
...
class tt_PlayerHandlerMock : tt_PlayerHandler
{
  ...
  <<mock-method("void", "reset", "int playerNumber")>>
  <<mock-method("void", "processKey", "tt_Character character")>>
  <<mock-method("void", "processInput", "int type")>>
  <<mock-method("void", "tick")>>
  <<mock-method("void", "reportDead", "Actor dead")>>
  <<mock-method("bool", "isCapturingKeys")>>
  <<mock-method("void", "unlockMode")>>
  <<mock-method("void", "forceCombat")>>
  <<mock-method("void", "draw", "RenderEvent event")>>
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/player_handler/tt_player_supervisor.zs
...
class tt_PlayerSupervisor : tt_PlayerHandler
{
  ...
  private static tt_Lesson makeLesson(tt_PlayerSource playerSource)
  {
    ...
    let mixedLessonSettings  = tt_MixedLessonSettingsImpl.of(playerSource);

    Array<tt_Lesson> lessonsForMixed = {
      tt_RandomCharactersLesson.of(randomLessonSettings),
      tt_StringSet.of("tt_gzdoom"),
      tt_StringSet.of("tt_cpp"),
      tt_MathsLesson.of(),
      tt_StringSet.of("tt_1000"),
      tt_StringSet.of("tt_1000_ru"),
      tt_StringSet.of("typist_custom_text"),
      tt_StringSet.of("tt_nix")
    };

    return tt_MixedLesson.of(mixedLessonSettings, lessonsForMixed);
  }
...
#+begin_src c :tangle build/Typist.pk3/zscript/server/tt_server.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/activatable/tt_activatable.zs
...
class tt_ActivatableMock : tt_Activatable
{
  ...
  tt_Satisfaction getSatisfaction() const
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. "activate",    isSatisfied_activate())
      .push(getClassName() .. "getCommands", isSatisfied_getCommands())
      .push(getClassName() .. "isVisible",   isSatisfied_isVisible());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/activatable/tt_pass_through.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/activatable/tt_command_dispatcher.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/aimer/tt_horizontal_aimer.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/aimer/tt_vertical_aimer.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/answer/tt_answer.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/answer/tt_answer_source.zs
...
class tt_AnswerSourceMock : tt_AnswerSource
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": getAnswer",  isSatisfied_getAnswer())
      .push(getClassName() .. ": reset",      isSatisfied_reset())
      .push(getClassName() .. ": processKey", isSatisfied_processKey());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/answer/tt_input_block_after_combat.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/answer/tt_player_input.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/answer_state/tt_answer_state.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/answer_state/tt_answer_state_source.zs
...
class tt_AnswerStateSourceMock : tt_AnswerStateSource
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": getAnswerState", isSatisfied_getAnswerState())
      .push(getClassName() .. ": reset",          isSatisfied_reset())
      .push(getClassName() .. ": processKey",     isSatisfied_processKey());
  }
}
...
#+begin_src c :tangle build/Typist.pk3/zscript/answer_state/tt_pressed_answer_state.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/character/tt_character.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/clock/tt_clock.zs
...
class tt_ClockMock : tt_Clock
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": getNow", isSatisfied_getNow())
      .push(getClassName() .. ": since",  isSatisfied_since());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/clock/tt_total_clock.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/event_handler/tt_event_handler.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/event_reporters/tt_answer_reporter.zs
...
class tt_AnswerReporterMock : tt_AnswerReporter
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": reportMatch",    isSatisfied_reportMatch())
      .push(getClassName() .. ": reportNotMatch", isSatisfied_reportNotMatch());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/event_reporters/tt_key_press_reporter.zs
...
class tt_KeyPressReporterMock : tt_KeyPressReporter
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": report", isSatisfied_report());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/event_reporters/tt_mode_reporter.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/event_reporters/tt_player_sound_player.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/event_reporters/tt_sound_answer_reporter.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/event_reporters/tt_sound_key_press_reporter.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/event_reporters/tt_sound_mode_reporter.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/event_reporters/tt_sound_player.zs
...
class tt_SoundPlayerMock : tt_SoundPlayer
{
  ...
  <<mock-method("void", "playSound", "string soundId")>>

  tt_Satisfaction getSatisfaction() const
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": playSound", isSatisfied_playSound());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/firer/tt_firer.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/game_tweaks/tt_game_tweaks.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/buddha/tt_buddha.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/input_manager/tt_input_by_mode_manager.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/input_manager/tt_pass_through_input_manager.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/input_manager/tt_input_manager.zs
...
class tt_InputManagerMock : tt_InputManager
{
  ...
  <<mock-method("void", "manageInput")>>
  <<mock-method("bool", "isCapturingKeys")>>

  tt_Satisfaction getSatisfaction() const
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": playSound", isSatisfied_manageInput())
      .push(getClassName() .. ": isCapturingKeys", isSatisfied_isCapturingKeys());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/key_processor/tt_key_processor.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/key_processor/tt_key_processors.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/known_target/tt_known_target.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/known_target/tt_known_targets.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/known_target/tt_known_target_source.zs
...
class tt_KnownTargetSourceMock : tt_KnownTargetSource
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": isEmpty",    isSatisfied_isEmpty())
      .push(getClassName() .. ": getTargets", isSatisfied_getTargets());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/known_target/tt_known_target_source_cache.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/known_target/tt_target_registry.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/known_target/tt_visible_known_target_source.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/lesson/tt_question_source.zs
...
class tt_LessonMock : tt_Lesson
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. "getQuestion", isSatisfied_getQuestion());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/lesson/tt_maths_lesson.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/lesson/tt_mixed_lesson.zs

class tt_MixedLesson : tt_Lesson
{
  static tt_MixedLesson of(tt_MixedLessonSettings settings, Array<tt_Lesson> lessons)
  {
  ...
  override tt_Question getQuestion()
  {
    ...
    for (uint i = 0; i < nLessons; ++i)
      if (_settings.getLessonEnabled(i)) enabledLessons.push(_lessons[i]);

    uint nEnabledLessons = enabledLessons.size();
    if (nEnabledLessons == 0) return NULL;

    uint randomLessonIndex = random[typist](0, nEnabledLessons - 1);

    return enabledLessons[randomLessonIndex].getQuestion();
  }

  private tt_MixedLessonSettings _settings;
...
#+begin_src c :tangle build/Typist.pk3/zscript/lesson/tt_random_characters_lesson.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/lesson/tt_random_number_source.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/lesson/tt_string_set.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/math/tt_math.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/mode/tt_mode.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/mode/tt_mode_source.zs
...
class tt_ModeSourceMock : tt_ModeSource
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": getMode", isSatisfied_getMode());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/mode/tt_auto_mode_source.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/mode/tt_delayed_combat_mode_source.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/mode/tt_mode_cascade.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/mode/tt_mode_storage.zs
...
class tt_ModeStorageMock : tt_ModeStorage
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": setMode", isSatisfied_setMode())
      .push(getClassName() .. ": getMode", isSatisfied_getMode());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/mode/tt_reported_mode_source.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/mode/tt_settable_mode.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/mode/tt_automap_mode_source.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/origin/tt_hasty_question_answer_matcher.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/origin/tt_origin.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/origin/tt_origin_source.zs
...
class tt_OriginSourceMock : tt_OriginSource
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": getOrigin", isSatisfied_getOrigin());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/origin/tt_origin_source_cache.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/origin/tt_player_origin_source.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/origin/tt_question_answer_matcher.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/origin/tt_selectable_origin_source.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/player/tt_player_source.zs
...
class tt_PlayerSourceMock : tt_PlayerSource
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": getInfo",   isSatisfied_getInfo())
      .push(getClassName() .. ": getPawn",   isSatisfied_getPawn())
      .push(getClassName() .. ": getNumber", isSatisfied_getNumber());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/player/tt_player_source_impl.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/question/tt_question.zs
...
class tt_QuestionMock : tt_Question
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": isRight",        isSatisfied_isRight())
      .push(getClassName() .. ": getDescription", isSatisfied_getDescription())
      .push(getClassName() .. ": getHintFor",     isSatisfied_getHintFor());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/question/tt_match.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/settings/tt_setting.zs
...
class tt_BoolSettingMock : tt_BoolSetting
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": isDefined", isSatisfied_isDefined())
      .push(getClassName() .. ": get",   isSatisfied_get());
  }
}
#+end_src
...
class tt_IntSettingMock : tt_IntSetting
{
  static tt_IntSettingMock of() { return new("tt_IntSettingMock"); }
...
class tt_FloatSettingMock : tt_FloatSetting
{
  ...
  <<mock-method("bool",   "isDefined")>>
  <<mock-method("double", "getFloat" )>>

  tt_Satisfaction getSatisfaction()
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": isDefined", isSatisfied_isDefined())
      .push(getClassName() .. ": getFloat",  isSatisfied_getFloat());
  }
}
#+end_src
...
class tt_StringSettingMock : tt_StringSetting
{
  static tt_StringSettingMock of() { return new("tt_StringSettingMock"); }

  <<mock-method("bool",   "isDefined")>>
  <<mock-method("string", "get")>>
...
#+begin_src c :tangle build/Typist.pk3/zscript/settings/tt_settings.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/settings/tt_cvars.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/settings/tt_random_characters_lesson_settings.zs
...
class tt_RandomCharactersLessonSettingsMock : tt_RandomCharactersLessonSettings
{
  ...
  <<mock-method("int",    "getLessonLength")>>
  <<mock-method("bool",   "isUppercaseLettersEnabled")>>
  <<mock-method("bool",   "isLowercaseLettersEnabled")>>
  <<mock-method("bool",   "isNumbersEnabled")>>
  <<mock-method("bool",   "isPunctuationEnabled")>>
  <<mock-method("bool",   "isSymbolsEnabled")>>
  <<mock-method("bool",   "isCustomCharactersEnabled")>>
  <<mock-method("string", "getCustomCharacters")>>

  tt_Satisfaction getSatisfaction()
  {
    string myName = getClassName();
    return tt_Satisfaction.of()
      .push(myName .. ": getLessonLength", isSatisfied_getLessonLength())
      .push(myName .. ": isUppercaseLettersEnabled",
            isSatisfied_isUppercaseLettersEnabled())
      .push(myName .. ": isLowercaseLettersEnabled",
            isSatisfied_isLowercaseLettersEnabled())
      .push(myName .. ": isNumbersEnabled", isSatisfied_isNumbersEnabled())
      .push(myName .. ": isPunctuationEnabled", isSatisfied_isPunctuationEnabled())
      .push(myName .. ": isSymbolsEnabled", isSatisfied_isSymbolsEnabled())
      .push(myName .. ": isCustomCharactersEnabled",
            isSatisfied_isCustomCharactersEnabled())
      .push(myName .. ": getCustomCharacters", isSatisfied_getCustomCharacters());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/settings/tt_random_characters_lesson_settings_impl.zs
...
class tt_MixedLessonSettings abstract
{
...
class tt_MixedLessonSettingsMock : tt_MixedLessonSettings
{
  static tt_MixedLessonSettingsMock of()
  {
    return new("tt_MixedLessonSettingsMock");
  }

  <<mock-method("bool", "getLessonEnabled", "uint i")>>

  tt_Satisfaction getSatisfaction()
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": getLessonEnabled", isSatisfied_getLessonEnabled());
  }
}
#+end_src

*** ~MixedLessonSettingsImpl~

#+begin_src c :tangle build/Typist.pk3/cvarinfo.txt

// Mixed Lesson configuration
user bool tt_is_lesson_enabled_0 = false;
user bool tt_is_lesson_enabled_1 = false;
user bool tt_is_lesson_enabled_2 = false;
user bool tt_is_lesson_enabled_3 = false;
user bool tt_is_lesson_enabled_4 = false;
user bool tt_is_lesson_enabled_5 = false;
user bool tt_is_lesson_enabled_6 = false;
user bool tt_is_lesson_enabled_7 = false;
user bool tt_is_lesson_enabled_8 = false;
user bool tt_is_lesson_enabled_9 = false;
#+end_src

#+begin_src c :tangle build/Typist.pk3/zscript/settings/tt_setting.zs

// Implements tt_MixedLessonSettings by reading values from user CVars.
class tt_MixedLessonSettingsImpl : tt_MixedLessonSettings
{
  static tt_MixedLessonSettingsImpl of(tt_PlayerSource playerSource)
  {
    let result = new ("tt_MixedLessonSettingsImpl");

    for (uint i = 0; i < N_IS_LESSON_ENABLED_CVARS; ++i)
    {
      string cvarName = string.format("tt_is_lesson_enabled_%d", i);
      result._isLessonEnabledCvars.push(tt_BoolCvar.of(playerSource, cvarName));
    }
  ...
  {
    return _isLessonEnabledCvars[index].get();
  }

  const N_IS_LESSON_ENABLED_CVARS = 10;

  private Array<tt_BoolCvar> _isLessonEnabledCvars;
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/stale_marker/tt_stale_marker.zs
...
class tt_StaleMarkerMock : tt_StaleMarker
{
  ...
  <<mock-method("bool", "isStale")>>

  tt_Satisfaction getSatisfaction()
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": isStale", isSatisfied_isStale());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/stale_marker/tt_stale_marker_impl.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/strings/tt_strings.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target/tt_death_reporter.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target/tt_target.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target/tt_target_radar.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target/tt_target_source.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target/tt_target_source_cache.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target/tt_target_source_pruner.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target/tt_targets.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target_widget/tt_projector.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target_widget/tt_sorter_by_distance.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target_widget/tt_target_widget.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target_widget/tt_target_widget_registry.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/target_widget/tt_target_widget_source.zs
...
class tt_TargetWidgetSourceMock : tt_TargetWidgetSource
{
  ...
  <<mock-method("tt_TargetWidgets", "getWidgets", "RenderEvent event")>>

  tt_Satisfaction getSatisfaction() const
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": getWidgets", isSatisfied_getWidgets());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/target_widget/tt_target_widgets.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/view/tt_view.zs
...
class tt_ViewMock : tt_View
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": draw", isSatisfied_draw());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/view/tt_views.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/view/tt_frame.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/interpolator/tt_double_interpolator.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/view/tt_conditional_view.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/view/tt_drawing.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/view/tt_info_panel.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/view/tt_target_overlay.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/world_changer/tt_world_changer.zs
...
class tt_WorldChangerMock : tt_WorldChanger
{
  ...
  <<mock-method("void", "changeWorld")>>

  tt_Satisfaction getSatisfaction()
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": changeWorld", isSatisfied_changeWorld());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/world_changer/tt_world_changers.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/world_changer/tt_enemy_speed_controller.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/world_changer/tt_projectile_speed_controller.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/world_changer/tt_velocity_storage.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/effect/tt_effect.zs
...
class tt_EffectMock : tt_Effect
{
  ...
  {
    return tt_Satisfaction.of()
      .push(getClassName() .. ": doEffect", isSatisfied_doEffect());
  }
}
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/effect/tt_gunner.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/effect/tt_answer_resetter.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/effect/tt_match_watcher.zs
...
#+begin_src c :tangle build/Typist.pk3/zscript/effect/tt_target_origin_sender.zs
...
OptionMenu tt_LessonOptions
{
  ...
  StaticText ""
  // TODO: add a fallback lesson so this is not needed.
  StaticText "Please enable at least one lesson."
...
#+begin_src c :tangle build/Typist.pk3/zscript/menu/tt_option_menu_item_animated_submenu.zs
...
void expect_%2$s(" (if isVoid "" "%1$s value, ") "int expected = 1)
{
  ...
  _mock_%2$s_expected = expected;
  _mock_%2$s_called   = 0;
}

private bool isSatisfied_%2$s()
{
  bool result = _mock_%2$s_expected == _mock_%2$s_called;
  if (!result) Console.printf(\"Expected: %%d, called: %%d\",
                              _mock_%2$s_expected,
                              _mock_%2$s_called);
  return result;
}
...
private int _mock_%2$s_expected;
private int _mock_%2$s_called;
