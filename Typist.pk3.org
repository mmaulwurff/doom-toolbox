...
class tt_PlayerSupervisor : tt_PlayerHandler
{
  static tt_PlayerSupervisor of(int playerNumber)
  {
    ...
    Array<tt_WorldChanger> gunnerParts = {
    ...
    Array<tt_WorldChanger> worldChangers = {
      tt_Gunner.of(targetOriginSource, tt_WorldChangers.of(gunnerParts)),
...
// Implements tt_WorldChanger by calling other tt_WorldChanger if there is some
// tt_Origin.
class tt_Gunner : tt_WorldChanger
{
  static tt_Gunner of(tt_OriginSource originSource,
                      tt_WorldChanger changer)
  {
    let result = new("tt_Gunner");
    result._originSource = originSource;
    result._changer      = changer;
    return result;
  }

  override void changeWorld()
  {
    if (_originSource.getOrigin() != NULL) _changer.changeWorld();
  }

  private tt_OriginSource _originSource;
  private tt_WorldChanger _changer;
}
#+end_src
...
}
{
  ...
  env.changer.expect_changeWorld();
...
class tt_GunnerTestEnvironment
{
  static tt_GunnerTestEnvironment of()
  {
    ...
    result.originSource = tt_OriginSourceMock.of();
    result.changer      = tt_WorldChangerMock.of();

    result.gunner = tt_Gunner.of(result.originSource, result.changer);
    return result;
  }
  ...
  tt_Satisfaction getSatisfaction() const
  {
    return originSource.getSatisfaction()
      .add(changer.getSatisfaction());
  }

  tt_OriginSourceMock originSource;
  tt_WorldChangerMock changer;
  tt_Gunner           gunner;
}
...
class tt_ProjectileSpeedController : tt_WorldChanger
{
  ...
  override void changeWorld()
  {
    ...
    foreach (Actor a : ThinkerIterator.Create("Actor", Thinker.STAT_DEFAULT))
      if (a.bMissile) controlProjectile(a, origin, playerRadius);
  }
  ...
  // Note: this method assumes that actor contains tt_VelocityStorage inventory item.
