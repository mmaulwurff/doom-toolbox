...
user bool tt_is_random_characters_enabled = false;
user bool tt_is_gzdoom_enabled = false;
user bool tt_is_cpp_enabled = false;
user bool tt_is_maths_enabled = false;
user bool tt_is_english_enabled = true;
user bool tt_is_russian_enabled = false;
user bool tt_is_custom_enabled = false;
user bool tt_is_unix_enabled = false;
#+end_src
...
#+begin_src c :tangle build/Typist.pk3/zscript/player_handler/tt_player_supervisor.zs
  ...
  private static tt_Lesson makeLesson(tt_PlayerSource playerSource)
  {
    ...
    Array<tt_SwitchableLesson> lessons = {
      tt_SwitchableLesson
        .of(tt_BoolCvar.of(playerSource, "tt_is_random_characters_enabled"),
            tt_RandomCharactersLesson.of(randomLessonSettings)),
      tt_SwitchableLesson
        .of(tt_BoolCvar.of(playerSource, "tt_is_gzdoom_enabled"),
            tt_StringSet.of("tt_gzdoom")),
      tt_SwitchableLesson
        .of(tt_BoolCvar.of(playerSource, "tt_is_cpp_enabled"),
            tt_StringSet.of("tt_cpp")),
      tt_SwitchableLesson
        .of(tt_BoolCvar.of(playerSource, "tt_is_maths_enabled"),
            tt_MathsLesson.of()),
      tt_SwitchableLesson
        .of(tt_BoolCvar.of(playerSource, "tt_is_english_enabled"),
            tt_StringSet.of("tt_1000")),
      tt_SwitchableLesson
        .of(tt_BoolCvar.of(playerSource, "tt_is_russian_enabled"),
            tt_StringSet.of("tt_1000_ru")),
      tt_SwitchableLesson
        .of(tt_BoolCvar.of(playerSource, "tt_is_custom_enabled"),
            tt_StringSet.of("typist_custom_text")),
      tt_SwitchableLesson
        .of(tt_BoolCvar.of(playerSource, "tt_is_unix_enabled"),
...
OptionMenu tt_LessonOptions
{
  ...
  Option "$TT_LESSON_RANDOM"  , tt_is_random_characters_enabled, OnOff
  Option "$TT_LESSON_GZDOOM"  , tt_is_gzdoom_enabled, OnOff
  Option "$TT_LESSON_CPP"     , tt_is_cpp_enabled, OnOff
  Option "$TT_LESSON_MATH"    , tt_is_maths_enabled, OnOff
  Option "$TT_LESSON_1000"    , tt_is_english_enabled, OnOff
  Option "$TT_LESSON_1000_RU" , tt_is_russian_enabled, OnOff
  Option "$TT_CUSTOM_TEXT"    , tt_is_custom_enabled, OnOff
  Option "$TT_NIX_LESSON"     , tt_is_unix_enabled, OnOff
