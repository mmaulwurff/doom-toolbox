...
TODO: multiplayer: add special generator for random().

TODO: passthrough Activatable: when activated, allows one ui event through (do not
capture one key press and release). Leave Combat mode enabled.
...
class tt_PlayerSupervisor : tt_PlayerHandler
{
  static tt_PlayerSupervisor of(int playerNumber)
  {
    ...
    {
      tt_Sphinx       .of(),
      tt_Reloader     .of(playerSource, commandSettings),

      //tt_RightDasher  .of(playerSource, commandSettings),
      //tt_LeftDasher   .of(playerSource, commandSettings),
      //tt_BackDasher   .of(playerSource, commandSettings),
      //tt_ForwardDasher.of(playerSource, commandSettings),
    ...
    Array<tt_WorldChanger> worldChangers = {
      tt_Gunner.of(targetOriginSource, aimer, tt_FirerImpl.of(playerSource)),
      tt_ProjectileSpeedController.of(originSource, playerSource),
      tt_EnemySpeedController.of(radarCache),
    ...
    result._keyProcessor       = tt_KeyProcessors.of(keyProcessors);
    result._deathReporter      = deathReporter;
    result._targetRegistry     = targetRegistry;
    result._view               = tt_ConditionalView.of(tt_Views.of(views));
    ...
    result._worldChanger       = tt_WorldChangers.of(worldChangers);
...
class tt_VisibleActivatable : tt_Activatable abstract
{
  override bool isVisible()
  {
    return true;
...
class tt_PassThrough : tt_VisibleActivatable
{
...
class tt_Dasher : tt_VisibleActivatable abstract
{
...
class tt_CommandDispatcher : tt_VisibleActivatable
{
  ...
  {
    return _settings.getCommandPrefix() .. command;
  }
...
{
  static tt_Aimers of(Array<tt_Aimer> aimers)
  {
    let result = new("tt_Aimers");
    result._aimers.move(aimers);
    return result;
  }
...
#+begin_src c :noweb-ref test-body
{
  ...
  Array<tt_Aimer> aimersArray = {aimer1, aimer2};
  let aimers = tt_Aimers.of(aimersArray);
...
class tt_EventHandler : EventHandler
{
  ...
  override void playerEntered(PlayerEvent event)
  {
    ...
    // TODO: multiplayer: initialize other players
...
// This class implements tt_Lesson by composing arithmetic tasks.
...
// This class implements tt_Lesson by composing a question from groups
...
// This class implements tt_Lesson by producing questions that contain
...
// This class implements tt_Lesson by selecting a question source
...
// This class implements tt_Lesson by reading a lump with words and
...
class tt_CommandSettingsImpl : tt_CommandSettings
{
  static tt_CommandSettingsImpl of(tt_PlayerSource playerSource)
  {
    ...
    result._rightDashCvar    = tt_Cvar.of(playerSource, "tt_command_right_dash"   );
    result._leftDashCvar     = tt_Cvar.of(playerSource, "tt_command_left_dash"    );
    result._forwardDashCvar  = tt_Cvar.of(playerSource, "tt_command_forward_dash" );
    result._backwardDashCvar = tt_Cvar.of(playerSource, "tt_command_backward_dash");
  ...
  override string getForwardDashCommand()  { return _forwardDashCvar .getString(); }
  override string getBackwardDashCommand() { return _backwardDashCvar.getString(); }
  override string getLeftDashCommand()     { return _leftDashCvar    .getString(); }
  override string getRightDashCommand()    { return _rightDashCvar   .getString(); }
  ...
  private tt_Cvar _rightDashCvar;
  private tt_Cvar _leftDashCvar;
  private tt_Cvar _forwardDashCvar;
  private tt_Cvar _backwardDashCvar;
...
Alias tt_reset_right_dash_command    "resetcvar tt_command_right_dash"
Alias tt_reset_forward_dash_command  "resetcvar tt_command_forward_dash"
Alias tt_reset_backward_dash_command "resetcvar tt_command_backward_dash"
Alias tt_reset_left_dash_command     "resetcvar tt_command_left_dash"
Alias tt_reset_reload_command        "resetcvar tt_command_reload"
#+end_src
