...
practical purpose. I'll be surprised if it finds any practical purpose. See [[Test][Test]] to
...
Key function is ~tl_Eval.eval~ function (see [[Eval][Eval]]). It takes a parsed expression
