...
(copy-directory "LICENSES" "build/Nomina/LICENSES" nil t t)
(copy-directory "documentation" "build/Nomina/documentation" nil t t)
(copy-file "Nomina.org" "build/Nomina/Readme.org" t)
#+end_src
