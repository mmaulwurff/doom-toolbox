...
PlainTranslator is a part of DoomToolbox.
...
#+begin_src c :tangle ../build/PlainTranslator/PlainTranslator.zs :exports none
...
#+begin_src c :tangle ../build/PlainTranslator/zscript.zs

version 4.14.3

#include "PlainTranslator.zs"
#+end_src

#+begin_src text :tangle ../build/PlainTranslatorTest/commands.txt
