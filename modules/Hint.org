...
This is Hint - option menu item for displaying hints.

Hint module version: 1.1.0

Hint is a part of DoomToolbox.
...
#+begin_src c :tangle ../build/Hint/Hint.zs :exports none
...
#+begin_src c :tangle ../build/Hint/zscript.zs
...
#+begin_src text :tangle ../build/HintTest/commands.txt
