...
#+begin_src c :tangle ../build/Autoautosave/cvarinfo.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/keyconf.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/language.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/mapinfo.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/menudef.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/sndinfo.txt :exports none
// <<license>>
#+end_src

#+begin_src c :tangle ../build/Autoautosave/zscript.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_active_enemies_checker.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_clock.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_counters.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_cvar.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_event_source.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_event.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_function.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_game_action_scheduler.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_game_actions.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_handlers.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_log.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_main.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_precache_sounds.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_save_timer.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_timestamp.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_token.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Autoautosave/zscript/aas_universal_token_examples.zs :exports none
// <<license>>
#+end_src

#+begin_src toml :tangle ../build/Autoautosave/REUSE.toml :exports none
...
(mapconcat
 (lambda (row) (format format-string
                       (nth 0 row)
                       (substring (nth 1 row) 1 -1)
                       (nth 2 row)
                       (nth 3 row)))
 (cdr table)
 delimiter)
...
#+begin_src js :tangle ../build/Autoautosave/events.json :exports none
{
  <<list-events("\"%1$s\": \"%4$s\"", ",\n")>>
}
#+end_src
...
#+begin_src c :noweb-ref tests-call :exports none
...
class aas_event_source play
{
  static aas_event_source of()
  {
    ...
    handlers.push(aas_logger.of(aas_print_function.of(aas_Fonts.findSmall()),
                                "aas_screen_level"));
...
#+begin_src text :noweb-ref tests-call :exports none
...
{
  static aas_print_function of(Font aFont)
  {
    let result = new("aas_print_function");
    result._font = aFont;
    return result;
  }

  override void f1(string s) { Console.midPrint(_font, s, true); }
...
#+begin_src c :tangle ../build/AutoautosaveTest/zscript.zs :exports none
