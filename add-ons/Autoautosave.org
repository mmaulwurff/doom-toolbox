...
class aas_event_source play
{
  static aas_event_source of()
  {
    ...
    {
      aas_saver .of(result._scheduler, result._clock, last_save_time),
  ...
  void on_thing_spawned(Actor item)
  {
    ...
    {
      aas_token(Actor.Spawn("aas_token", item.pos)).init(aas_event.important, _handler, NULL);
      return;
    }
