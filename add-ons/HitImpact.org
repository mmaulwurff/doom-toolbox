...
Known issues:
- Performance. HitImpact reduces the amount of particles created when many
  hits happen in a short period of time, but performance drop is still inevitable.
...
- Accuracy. Don't expect physical simulation level of precision. It's approximations
  and compromises salad. Help appreciated.
