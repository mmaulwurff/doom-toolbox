...
If a class is forced on, it is always active and hidden from option menus.
If a class is forced off, it is always disabled and hidden from option menus.

Several configurations may be loaded at once. If more than one configuration
