...
Typist.pk3 is a part of [[https://github.com/mmaulwurff/doom-toolbox/][DoomToolbox]].

** How to play

The default game mode is Exploration. It's like normal game play, except when you
...
- the player can't die, only lose health only down to 1 point (can be disabled)
...
- "pass-through" command (~/pass~ by default). After you enter this command, the
  following keyboard key acts like in normal game. You can switch weapons, move
  and shoot while remaining in Combat mode
- scoring, with high scores table
- options to enable infinite ammo, to disable enemy infighting, and to configure the
  HUD
- sound themes for Typist.pk3 events (can be turned off)
...
Typist.pk3 isn't coded specifically for any game, so there is a chance it's
compatible with many UZDoom mods and games.

- Typist.pk3 won't play well with mods and games which rely on melee combat:
  Typist.pk3 will only aim and fire, not move.
- Actors that are normally friendly, but changed their friendliness by scripts, don't
  count as targets.
- Typist.pk3 isn't compatible with Guncaster and Guncaster Vindicated.
  They read input directly from player, so weapon firing can't be
  emulated like for other mods. Guncaster support can't be added without
...
#+begin_src c :tangle ../build/Typist.pk3/cvarinfo.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/keyconf.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/language.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/mapinfo.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/menudef.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/sndinfo.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/tt_colors.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript.zs :exports none
// <<license>>
#+end_src

#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_lp_LazyPointsParameters.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_activatable.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_event_handler.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_game_tweaks.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_buddha.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_player_handler.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_world_changer.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_answer.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_answer_state.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_character.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_clock.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_effect.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_event_reporters.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_input_manager.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_interpolator.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_key_processor.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_known_target.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_lesson.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_math.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_option_menu_item_animated_submenu.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_mode.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_origin.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_player.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_question.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_server.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_settings.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_stale_marker.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_strings.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_target.zs :exports none
 // <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_target_widget.zs :exports none
 // <<license>>
#+end_src
#+begin_src c :tangle ../build/Typist.pk3/zscript/tt_view.zs :exports none
 // <<license>>
#+end_src
...
class tt_EventHandler : EventHandler
{
  ...
  override void consoleProcess(ConsoleEvent event)
  {
    ...
    if (!tt_su_su.beginsWith(command, "tt_")) return;
...
class tt_PlayerSupervisor : tt_PlayerHandler
{
  ...
  override void reset(int playerNumber)
  {
    ...
    Array<tt_View> views = {
      tt_TargetOverlay.of(widgetSorter, playerInput, scaleSetting, modeSource, aFont),
...
// TODO: fix when is an enemy is visible, but its middle isn't.
...
class tt_KnownTargets
{
  ...
  // If the target isn't in the list, does nothing.
...
class tt_TargetRegistry : tt_KnownTargetSource
{
  ...
  // Adds targets that aren't already registered to the registry.
  //
...
class tt_VisibleKnownTargetSource : tt_KnownTargetSource
{
  ...
  // Play-const hack: Actor.isVisible(...) isn't const, but should be.
...
class tt_RandomCharactersLesson : tt_Lesson
{
  ...
  private string composeCharacterRange()
  {
    ...
    {
      // UZDoom can't handle "\\" in a string, so add it manually.
  ...
  private static string pick(string characters, int number)
  {
    ...
    for (int i = 0; i < number; ++i)
    {
      ...
      int character   = tt_su_su.getCodePointAt(characters, randomIndex);
...
// Note that the Origin position can't change once set.
class tt_Origin
{
...
class tt_BoolCvar : tt_BoolSetting
{
  static tt_BoolCvar of(tt_PlayerSource playerSource, string name)
  {
    ...
    if (result._cvar != NULL && result._cvar.getRealType() != Cvar.CVAR_Bool)
      throwAbortException("%s Cvar isn't bool", name);
    return result;
  }
...
class tt_PositiveIntCvar : tt_IntSetting
{
  static tt_PositiveIntCvar of(tt_PlayerSource playerSource, string name)
  {
    ...
    if (result._cvar != NULL && result._cvar.getRealType() != Cvar.CVAR_Int)
      throwAbortException("%s Cvar isn't int", name);
    return result;
  }
...
class tt_FloatCvar : tt_FloatSetting
{
  static tt_FloatCvar of(tt_PlayerSource playerSource, string name)
  {
    ...
    if (result._cvar != NULL && result._cvar.getRealType() != Cvar.CVAR_Float)
      throwAbortException("%s Cvar isn't float", name);
    return result;
  }
...
class tt_StringCvar : tt_StringSetting
{
  static tt_StringCvar of(tt_PlayerSource playerSource, string name)
  {
    ...
    if (result._cvar != NULL && result._cvar.getRealType() != Cvar.CVAR_String)
      throwAbortException("%s Cvar isn't string", name);
    return result;
  }
...
** Random characters lesson settings
...
*** Random characters lesson settings implementation
...
}
{
  ...
  it(tag .. ": distant actor isn't in list",
...
}
{
  ...
  it(tag .. ": non-living actor isn't in list",
...
}
{
  ...
  it(tag .. ": dead actor isn't in list",
...
class tt_TargetWidgetRegistry : tt_TargetWidgetSource
{
  ...
  override tt_TargetWidgets getWidgets(RenderEvent event)
  {
    ...
    // Widgets that aren't new or not updated are thrown away.
...
class tt_InfoPanel : tt_View
{
  ...
  override void draw(RenderEvent _)
  {
    ...
    for (uint c = 0; c < commandCount; ++c)
    {
      ...
      let [width, height] = tt_Drawing.getBoxSize(command,
                                                  hintedAnswer,
                                                  scale,
                                                  _font);
...
class tt_Drawing ui
{
  ...
  static int, int getBoxSize(string question,
                             string answer,
                             int scale,
                             Font aFont)
  {
  ...
  static void drawTarget(int    x,
                         ...
                         Font   aFont)
  {
    drawBox(x, y, width, height, question, scale, tt_RgbColors.Question, aFont);
    drawBox(x, y + height, width, height, answer, scale, answerColor, aFont);
  }
...
OptionMenu tt_Options
{
  ...
  Submenu    "$tt_Controls", tt_Controls

  StaticText ""
  Submenu    "$tt_GeneralOptions", tt_GeneralOptions
  Submenu    "$tt_LessonOptions",  tt_LessonOptions
  Submenu    "$tt_SoundOptions",   tt_SoundOptions
}

OptionMenu tt_GeneralOptions
{
  Title      "$tt_GeneralOptions"

  StaticText ""
  Option     "$tt_AutoConfirmation", tt_fast_confirmation, OnOff

  StaticText ""
  Slider     "$tt_TargetTextScale", tt_view_scale, 1, 4, 1, 0

  StaticText ""
  StaticText "$tt_ReduceDistractions"

  StaticText ""
  Option     "$tt_PlayerNodie", tt_buddha_enabled, OnOff
  StaticText "$tt_AppliesOnStart"

  StaticText ""
  Option     "$tt_InfiniteAmmo",    sv_infiniteammo, OnOff
  Option     "$tt_EnemyInfighting", infighting, tt_InfightingValues

  StaticText ""
  Option     "$tt_HUD",         screenblocks, tt_HudValues
  Option     "$tt_ShowScore",   tt_lp_show, OnOff
  Slider     "$tt_PainFlash",   blood_fade_scalar,  0, 1.0, 0.1
  Slider     "$tt_PickupFlash", pickup_fade_scalar, 0, 1.0, 0.1
}
...
{
  Title      "$tt_LessonOptions"

  Option     "$tt_1000English",      tt_is_english_enabled, OnOff
  Option     "$tt_RandomCharacters", tt_is_random_enabled,  OnOff
  Option     "$tt_Arithmetic",       tt_is_maths_enabled,   OnOff
  Option     "$tt_CustomText",       tt_is_custom_enabled,  OnOff

  StaticText ""
  Submenu    "$tt_RandomCharactersConfiguration", tt_RandomLesson

  StaticText ""
  Command    "$tt_UpdateTargets", tt_reset_targets

  StaticText ""
  StaticText "$tt_HowToCustom"
...
OptionMenu tt_Controls
{
  ...
  StaticText ""
  TextField  "$tt_PassThroughCommand", tt_command_pass_through
  StaticText "$tt_PassThroughDescription"
...
{
  Title  "$tt_SoundOptions"

  Option "$tt_SoundEffects", tt_sound_enabled, OnOff
  Option "$tt_TypingSound",  tt_sound_typing_enabled, OnOff
  Option "$tt_SoundTheme",   tt_sound_theme, tt_SoundThemes
}

OptionMenu tt_RandomLesson
{
  Title  "$tt_RandomCharactersConfiguration"

  Slider "$tt_Length", tt_rc_length, 1, 10, 1, 0
  ...
  Option "$tt_Punctuation",             tt_rc_punctuation_enabled       , OnOff
  Option "$tt_OtherCharacters",         tt_rc_symbols_enabled           , OnOff

  StaticText ""
  Option     "$tt_CustomString", tt_rc_custom_enabled, OnOff
  TextField  "$tt_CustomString", tt_rc_custom, tt_rc_custom_enabled
}
#+end_src
...
class OptionMenuItemtt_AnimatedSubmenu : OptionMenuItemSubmenu
{
  ...
  override int Draw(OptionMenuDescriptor desc, int y, int indent, bool selected)
  {
    ...
    mLabel = (highlightedLetterIndex < _originalLength)
      ? tt_su_su.highlight(_originalLabel, highlightedLetterIndex, Font.CR_Green)
      : _originalLabel;
...
<<../tools/scripts.org:include("add-ons/Typist.pk3.org", "build/Typist.pk3/\\(zscript/.*zs\\)")>>
#include "tt_colors.zs"

#include "zscript/tt_Fonts.zs"
#include "zscript/tt_LazyPoints.zs"
#include "zscript/tt_le_libeye.zs"
#include "zscript/tt_su_StringUtils.zs"
#+end_src

Modules:
- [[file:../modules/Fonts.org][Fonts]]
- [[file:../modules/LazyPoints.org][LazyPoints]]
- [[file:../modules/libeye.org][libeye]]
- [[file:../modules/StringUtils.org][StringUtils]]

#+begin_src text :tangle ../build/tmp/Typist.pk3.txt :exports none
...
<<../tools/scripts.org:include("add-ons/Typist.pk3.org", "build/Typist.pk3Test/\\(zscript/.*zs\\)")>>
#+end_src
...
wait 2; map map01; sv_fastweapons 2
wait 4; summon doomimp
wait 6; netevent test:tt_Test
wait 8; quit
#+end_src
