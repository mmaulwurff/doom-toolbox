...
- move to the new translation system
...
- don't show sound when sector isn't moving
- redesign UI
- check performance
...
OptionMenu st_Menu
{
  ...
  StaticText  "$st_Position"
  Slider      "$st_Horizontal", st_x_position, 0.0, 1.0, 0.01, 2
  Slider      "$st_Vertical",   st_y_position, 0.0, 1.0, 0.01, 2

  StaticText  ""
  Slider      "$st_Width",      st_x_radius, 20, 50, 1
  Slider      "$st_Height",     st_y_radius, 20, 50, 1
  Slider      "$st_DotSize",    st_dot_size,  1,  9, 2
  Slider      "$st_Opacity",    st_alpha, 0.1, 1.0, 0.1, 1

  StaticText  ""
  Option      "$st_OnAutomap", st_on_automap, OnOff

  StaticText  ""
  StaticText  "$st_Colors"
  ColorPicker "$st_Base",   st_color_base
  ColorPicker "$st_Noise",  st_color_noise
  ColorPicker "$st_Level",  st_color_geometry
  ColorPicker "$st_Danger", st_color_danger
  ColorPicker "$st_Player", st_color_player
}
