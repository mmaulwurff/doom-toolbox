...
Tests run when instantiated by default, which can be disabled by overriding ~Init()~.
...
SPDX-FileCopyrightText: © 2018 ZippeyKeys12, © 2019 Alexander Kromm (m8f) <mmaulwurff@gmail.com>
...
class Cl_Util{
    static
    clearscope
    void Print(String Output, Name CVarName){
