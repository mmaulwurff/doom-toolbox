...
- Cheat codes that contain keys assigned for weapon slots aren't supported as
  Gearbox blocks them.
- Freezing enemies when menu is opened doesn't play well with ~freeze~ console
  command: everything may stay frozen.

** Creating a soundpack

1. Replace the GB_PACK string in language.txt with your soundpack's name,
2. Replace the sndinfo definitions with your own sounds, for example:
...
3. Select "Custom Soundpack" in the Gearbox UI options, and check
   if your sounds work.
...
#+begin_src c :tangle ../build/Gearbox/menudef.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/cvarinfo.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/sndinfo.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/language.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/keyconf.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/mapinfo.txt :exports none
// <<license>>
#+end_src

#+begin_src c :tangle ../build/Gearbox/zscript/activity.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/changer.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/custom_weapon_order_storage.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/event_processor.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/gb_font_selector.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/freezer.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/input.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/input_processor.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/inventory_menu.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/inventory_user.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/netevent_processor.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/options.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/printer.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/sender.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/sounds.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/view_model.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/weapon_data.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/weapon_data_loader.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/weapon_menu.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/display/blocky_view.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/display/blur.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/gldefs.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/shaders/mfx_bss_blur.fp :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/display/caption.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/display/dim.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/display/fade_in_out.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/display/text_view.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/engine/level.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/engine/player.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/engine/weapon_watcher.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/event_handler.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/service/service.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/service/icon_service.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/service/hide_service.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/tools/ammo.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/tools/cvar.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/tools/log.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/tools/texture_cache.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/wheel/controller.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/wheel/controller_model.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/wheel/indexer.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/wheel/inner_indexer.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/wheel/multiwheel.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/wheel/multiwheel_mode.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/wheel/screen.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/wheel/text.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/Gearbox/zscript/wheel/view.zs :exports none
// <<license>>
#+end_src
...
v0.8.1
- expand "reverse cycling order" behavior
- set original weapons order as default
- fix blocks view max height calculation

v0.8.0
- add option to print selection
- fix weapon order to match original order
- use custom order even when not "intercepting"
- align menu icon
- remove prompts for safe commands
- fix warnings: replace uint with int
- adds dropping from the menu

v0.7.3
- fix VM Abort when ~externalSelectedIndexInModel~ isn't set
- ~TextureID~ type fixes for GZDoom 4.14
- fix opening the menu on single weapon
- fix VM abort when pending weapon is NULL
- add Brazilian Portuguese localization

v0.7.2
- don't open weapon menu if there is no weapons
- fix text out of weapon blocks
- replace ellipsis with three dots for fonts that don't have ellipsis
- feature/option select first slot weapon
- feature: option to reverse slot cycle order
- add audio feedback when menu can't be opened
- fix a bug by which the inventory was "invisibly" opened and closed when there were no items
- now there is a code-wise difference between the open and close menu sounds
- fix toggle and tick sounds played at the same time

v0.7.1
- fix a crash on Delta Touch with GLES 3.2 caused by blur shader
- add menu command to copy custom player color
- make custom weapon order keys descriptions more clear
- fix gitignore
- search for textures more precisely

v0.7.0
- don't scale weapons with no icons in wheel
- prevent weapon sway in wheel
- fix changing weapon order
- fix keyconf lump
- adapt to inverted mouse settings
- organize menus
- fix VM abort in inventory menu
- synchronize cvar lists
- add resetting custom weapon order
- add key to change weapon slot
- add key to change weapon priority
- add font selection

v0.6.0
- fix VM abort in text view when no weapons
- add plain text view
- fix: take into account weapon scaling properties for icons
- fix: SWWM GZ - two Explodium guns can be selected
- fix: velocity after freezing was restored even if freezing is off
- fix: unblock mouse input in Blocks view
- update build script
- add more null checks

v0.5.1
- add space after menu titles
- fix using inventory items when player is frozen
- fix wheel hands length

v0.5.0
- fix truncation of floating point warning
- update Zabor, and an option to disable it
- Revert "wheel: draw weapon tag if it has no icon"
- add wheel scale
- separate Screen class from blocks view, move to wheel
- remove redundant menu option
- move text drawing class to wheel
- display weapon name tags on change with native GZDoom function
- fix gravity after closing gearbox
- wheel: draw weapon tag if it has no icon
- add compatibility with Event Handler Destroyer
- add Gearbox options menu to simplified options menu
- don't call statusbar instance for static ~getInventoryIcon~ function
- fix height when frozen in Heretic water
- move networking to sender
- add icon to options menu
- rework player and enemies freezing
- add KeksDose to Acknowledgments
- new input
- update VM abort handler
- fix blocks view positioning

v0.4.1
- hardcode icons for Smooth Doom
- prevent VM abort when no inventory items
- fix selecting hidden weapons
- make previous weapon carry over to the next level
- prevent blocks inventory view from aborting VM when there are no items
- don't draw placeholder icon in blocks view
- increase max multiwheel threshold, draw selected weapon on top
- add note about keys to Readme
- fix constant ticking on tomed weapons
- fix VM abort when the last inventory item is used up
- fix misaligned quantity dots when quantity is odd
- add missing cvars to Zabor and ~gb_reset~
- fix truncation of floating point values

v0.4
- better handling of tall weapon icons
- don't rotate items in wheel, respect preserve aspect ration setting
- add an option to set if frozen player can open Gearbox
- move UI options to a submenu
- add reset to defaults command
- make position configurable for blocks view
- add blur option
- add a command for manual report
- add cvars dump to VM event handler
- add VM abort handler
- add select previous weapon key from m_gizmos
- fix complementary colors in blocks view
- fix division by zero when max ammo is 0
- don't draw 10 pips if ammo or number of items is less than 10
- wheel: don't move weapon description if not necessary
- fix repeated ticking when player has no weapons
- don't show amount for items with max amount 1
- add menudef entry for inventory menu key
- allow slot keys in inventory menu
- add tick sound to inventory menu
- fix next/previous buttons in inventory menu
- bare-bones inventory menu

v0.3.2
- increase minimal angle between wheel hands for clarity
- make wheel hands transparent in the middle
- draw the selected thing in the second wheel on top of other things
- remove a message for obsolete key bind
- fix out of bounds angle on the second wheel
- limit minimal angle between wheel hands
- let Gearbox know the current selected weapon

v0.3.1
- add missing people to Acknowledgments
- make sound effects optional
- wheel: don't move weapon description if not in multiwheel mode
- disable Gearbox in intermission screen
- remove partial LZDoom compatibility

v0.3
- fix VM abort when no weapons, AGAIN
- smoother text background image
- make lower limit for text box width
- add optional locked position mode
- more distinct elements color for black or white blocks view
- make displaying weapon tags on weapon change respect GZDoom option
- fix drawing text box on top of wheel when the screen is scaled
- add an option to display weapon tags
- unify fonts, remove font selection
- add weapon tags to blocks view
- add weapon tag display after changing weapons
- remove one parameter from text box drawing function
- move drawing text into a separate file
- move some display-related files into a directory
- move texture cache out of wheel view, cache blocks view textures
- fix text box color and increase background image resolution
- add weapon tag display to wheel
- fix blocks view index
- add open/close sound
- add tick sound
- allow catching more than 2 key bindings
- add a note regarding PyWeaponWheel
- cache view model
- store ammo pip size in cache
- cache scale factor in wheel
- add texture cache to wheel. performance gain is non-existent
- fix warnings, combine coordinate operations into vector operations
- implement ammo display on wheel
- make disabling Gearbox on automap optional
- fix overriding icons from invalid ones from service
- LZDoom half-compatibility: only Blocks view
- add ~HideService~ to show ~DualExplodiumGun~ from SWWM GZ only when appropriate
- implement icon patches via Service
- more consistent selection in multiwheel
- multiwheel: click on slot selects the first weapon in this slot
- add patches with icon support
- fix bug with not selecting slot on slot key
- add an option to open menu on slot key
- move slot input check to a function
- don't open gearbox in automap
- fix file conflict with other mods
- add screen dim color option
- fix VM abort on no weapons again
- tweak wheel hands graphics
- remove unnecessary hiding of wheel elements on alpha != 1
- fix weapon selection snapping to selected weapon on fade out
- close weapon selection by altfire
- add smooth wheel graphics by Accensus

v0.2.2
- add gradient to wheel background
- add multiwheel engagement weapon number slider
- prevent opening gearbox while dead
- more reliable freezing while menu is opened
- fix VM abort in hubs

v0.2.1
- add time freezing
- fix multiplayer synchronization
- fix reaction to slot keys in some circumstances
- fix selecting a weapon if it's only one in slot
- add protection against the case when player has no weapons at all
- make colored tint on wheel weapons optional
- add an option to select font for wheel slots
- add little notches on sides of wheel selection bars

v0.2
- reorganize option menu
- add an option for wheel horizontal position
- fix preventing cheat code input in some circumstances
- fix possible VM abort when dropping weapons
- fix scaling for blocks view
- fix scaling wheel pointer
- fix wheel weapon selection scaling
- fix slot label scaling
- remove hardcoded radius
- react to scaling changes
- fix VM abort due to computational error
- fix VM abort with QCDE
- restore indexing the wheel by keys
- multiwheel: indexer works fine
- prettier multiwheel
- WIP multiwheel more
- optimize graphics
- WIP multiwheel
- don't let wheel pointer get from screen bounds
- fix VM abort with blocks view when there is only one weapon
- reset wheel pointer on number keys
- fix VM abort with QCDE
- don't reset wheel state on unrelated input keys
- fix bug with cloning the wheel twice
- add changelog script
- add an option to immediately select weapon if it's only one in slot
- add reaction to number keys
- move screen dimming out of the wheel view and make it optional
- add an option to select the weapon on key release
- implement mouse sensitivity sliders
- don't show ammo2 view if it's the same as ammo1
- add an option to disable mouse input in weapon wheel
- bump required GZDoom version
...
OptionMenu gb_BehaviorOptions
{
  ...
  Option      "$GB_REVERSE_SLOT_CYCLE_ORDER", gb_reverse_slot_cycle_order, OffOn
...
GB_REVERSE_SLOT_CYCLE_ORDER = "Reverse cycling order inside slots";
...
# This is just to put ResetCvar entries on a single line in code.
#+name: gb_reset
#+begin_src elisp :exports none :noweb-prefix no
(org-trim (string-replace "\n" " " "

ResetCvar gb_scale;
ResetCvar gb_color;
ResetCvar gb_dim_color;
ResetCvar gb_show_tags;
ResetCvar gb_view_type;
ResetCvar gb_enable_dim;
ResetCvar gb_enable_blur;
ResetCvar gb_wheel_position;
ResetCvar gb_wheel_scale;
ResetCvar gb_wheel_tint;
ResetCvar gb_multiwheel_limit;
ResetCvar gb_blocks_position_x;
ResetCvar gb_blocks_position_y;
ResetCvar gb_text_scale;
ResetCvar gb_text_position_x;
ResetCvar gb_text_position_y;
ResetCvar gb_text_position_y_max;
ResetCvar gb_text_usual_color;
ResetCvar gb_text_selected_color;
ResetCvar gb_open_on_scroll;
ResetCvar gb_open_on_slot;
ResetCvar gb_reverse_slot_cycle_order;
ResetCvar gb_select_first_slot_weapon;
ResetCvar gb_mouse_in_wheel;
ResetCvar gb_select_on_key_up;
ResetCvar gb_no_menu_if_one;
ResetCvar gb_on_automap;
ResetCvar gb_lock_positions;
ResetCvar gb_enable_sounds;
ResetCvar gb_frozen_can_open;
ResetCvar gb_time_freeze;
ResetCvar gb_mouse_sensitivity_x;
ResetCvar gb_mouse_sensitivity_y;
"))
#+end_src
...
<<../tools/scripts.org:include("add-ons/Gearbox.org", "build/Gearbox/\\(zscript/.*zs\\)")>>

#include "zscript/gb_Fonts.zs"
...
#+begin_src c :tangle ../build/Gearbox/zscript/gb_font_selector.zs
...
class gb_FontSelector
{
  ...
  Font getFont()
  {
    string newFontName = mFontString.getString();
    if (mOldFontName.length() > 0 && mOldFontName == newFontName)
      return mFont;

    if (newFontName == "NewSmallFont")
      mFont = gb_Fonts.findSmall();
    else if (newFontName == "ConsoleFont")
      mFont = gb_Fonts.findConsole();
    else if (newFontName == "BigFont")
      mFont = gb_Fonts.findBig();
    else
      mFont = Font.getFont(newFontName);

    if (mFont == NULL && mOldFontName.length() > 0)
      Console.printf(StringTable.localize("$GB_BAD_FONT"), newFontName);
...
// totally frozen. Therefore, we have to wait until player isn't frozen.
...
class gb_NeteventProcessor play
{
  ...
  {
    if (!gb_su.beginsWith(event.name, "gb_")) return InputNothing;
...
user bool gb_reverse_slot_cycle_order  = true;
...
class gb_WeaponDataLoader play
{
  ...
  static void load(out gb_WeaponData data, bool isOriginalOrder)
  {
    gb_WeaponInfo info;
    PlayerInfo player = players[consolePlayer];
    ...
    foreach (aClass : AllActorClasses)
    {
      ...
      if (isOriginalOrder) priority = 99 - priority;
...
class gb_WeaponMenu
{
  ...
  bool selectSlot(int slot, bool selectFirstWeapon = false)
  {
    ...
    int startOffset = selectFirstWeapon ? 0 : (mSelectedIndex + 1);

    for (int i = 0; i < nWeapons; ++i)
    {
      int index = (startOffset + nWeapons + 1 * i) % nWeapons;
...
class gb_BlockyView
{
  ...
  private void drawTag(string tag, Font aFont, double startX, double startY)
  {
    ...
    // fit into the line, it's pushed into the new top line.
    Array<string> lines;
...
class gb_EventHandler : EventHandler
{
  ...
  private void resetCustomOrder()
  {
    ...
    gb_WeaponDataLoader.load(weaponData, !mOptions.isSlotCycleOrderReversed());
