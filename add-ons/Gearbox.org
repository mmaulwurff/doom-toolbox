...
- removed unused and missing sound definition
...
OptionMenu gb_Options
{
  ...
  Submenu     "$GB_ENGINE_OPTIONS"   , gb_EngineOptions
...
OptionMenu gb_EngineOptions
{
  Title "$GB_ENGINE_OPTIONS_TITLE"
...
OptionMenu gb_UiOptions
{
  ...
  StaticText  ""
  Option      "$GB_PRINT_SELECTION", gb_print_selection, OnOff
...
#+begin_src text :tangle ../build/tmp/Gearbox.txt :exports none
