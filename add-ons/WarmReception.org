...
WarmReception is a part of [[https://github.com/mmaulwurff/doom-toolbox/][DoomToolbox]].
...
Known issues:
- [[https://github.com/UZDoom/UZDoom/issues/1238][Actor.CheckSight freezes RAMP 2024]]
...
// <<license>>
#+end_src
#+begin_src c :tangle ../build/WarmReception/zscript.zs :exports none
// <<license>>
#+end_src
...
wr_TurnRandomly = "Turn to a random direction";
...
#+begin_src c :tangle ../build/WarmReception/zscript.zs
