...
- Options to disable crosshair on slot 1 and when weapon isn't ready;
...
v1.2:
- add options to disable precise crosshair on slot 1 and when weapon isn't ready
...
#+begin_src c :tangle ../build/PreciseCrosshair/menudef.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/cvarinfo.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/language.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/xhairs.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/mapinfo.txt :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/zscript.zs :exports none
// <<license>>
#+end_src

#+begin_src c :tangle ../build/PreciseCrosshair/zscript/pc_event_handler.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/zscript/pc_puff.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/zscript/settings/pc_bool_setting.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/zscript/settings/pc_cvar_setting.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/zscript/settings/pc_settings.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/zscript/settings/pc_settings_base.zs :exports none
// <<license>>
#+end_src
#+begin_src c :tangle ../build/PreciseCrosshair/zscript/settings/pc_settings_pack.zs :exports none
// <<license>>
#+end_src
...
#+begin_src text :tangle ../build/tmp/PreciseCrosshair.txt :exports none
...
class pc_SettingsBase abstract
{
  // Reset CVars to their default values.
  abstract void resetCvarsToDefaults();
}
#+end_src
...
#+begin_src c :tangle ../build/PreciseCrosshairTest/zscript.zs

version 4.14.3

class TestPistol : Pistol replaces Pistol
{
  States
  {
    Ready:
      PISG A 0 A_SetCrosshair(1);
      PISG A 1 A_WeaponReady();
      Loop;
    Fire:
      PISG B 1 A_SetCrosshair(-1);
      PISG C 1 A_Refire();
      Goto Ready;
  }
}
