...
class ts_EventHandler : StaticEventHandler
{
  override void onRegister()
  {
    ...
    collectClasses();
    mFader = new("ts_Fader");
    (mBlacklist = new("ts_Blacklist")).initialize();
  }
  ...
  override void renderOverlay(RenderEvent event)
  {
    ...
    mView.call(mInformationPieces, mFader.getAlpha(event.fracTic));
  }
  ...
  private bool tryAddView(class<Object> aClass)
  {
    ...
    let view = (Function<ui void(Array<ts_InformationPiece>, double)>)
  ...
  Function<ui void(Array<ts_InformationPiece>, double)> mView;
...
class ts_Fader
{
  ...
  const FADE_TIME_TICS = TICRATE / 2;
...
{
  static ui void draw(Array<ts_InformationPiece> informationPieces, double alpha)
  {
    ...
    foreach (piece : informationPieces)
    {
      ...
      drawText(aFont, text, xCenter, y, alpha);
      y += lineHeight;
    }
  }
  ...
  static private ui void drawText(Font aFont,
                                  string text,
                                  int xCenter,
                                  int y,
                                  double alpha)
