...
src_c{Clematis.Create('ClematisExample');}

**** Network Event

src_c{EventHandler.SendNetworkEvent('test:ClematisExample');}
...
<<tools/scripts.org:include("ClematisM.org", "build/ClematisM/\\(zscript/.*zs\\)")>>
#+end_src
