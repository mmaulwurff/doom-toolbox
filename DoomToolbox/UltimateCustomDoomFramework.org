...
#+begin_src js :tangle ../build/UltimateCustomDoomF/options/BasicGameplay/cd_option.WeaponDamage.json
{
  "class": "cd_Engine",
...
#+begin_src js :tangle ../build/UltimateCustomDoomF/options/BasicGameplay/cd_option.TakenDamage.json
{
  "class": "cd_Engine",
...
#+begin_src js :tangle ../build/UltimateCustomDoomF/options/AdvancedGameplay/cd_option.StartHealth.json
{
  "class": "cd_Engine",
  "setter": "setHealth",
  "when": "onGameStart"
