...
class cd_EventHandler : StaticEventHandler
{
  ...
  override void playerRespawned(PlayerEvent event)
  {
    ...
    activateOptions(cd_Option.OnGameStart);
  }
...
#+begin_src c :tangle ../build/UltimateCustomDoomF/zscript/cd_Engine.zs
...
#+begin_src ini :tangle ../build/UltimateCustomDoomF/language.txt
[enu default]
CD_OPTION_StartHealth = "Start health multiplier";
#+end_src
...
#+begin_src js :tangle ../build/UltimateCustomDoomF/options/02/AdvancedGameplay/cd_option02.StartArmor.json
{
  "class": "cd_Engine",
  "setter": "setArmor",
  "when": "onGameStart"
...
Note: armor save percent is handled differently. The option itself does nothing, but it is read in cd_StartArmorBonus.

#+begin_src js :tangle ../build/UltimateCustomDoomF/options/02/AdvancedGameplay/cd_option03.StartArmorSavePercent.json
{
  "class": "cd_Engine",
  "setter": "doNothing",
  "when": "onGameStart"
...
#+begin_src ini :tangle ../build/UltimateCustomDoomF/language.txt
[enu default]
CD_OPTION_StartArmor = "Start armor";
CD_OPTION_StartArmorSavePercent = "Save percent";
#+end_src

#+begin_src c :tangle ../build/UltimateCustomDoomF/zscript/cd_Engine.zs
extend class cd_Engine
{
  static void setArmor(double value)
  {
    getPawn().giveInventory("cd_StartArmorBonus", int(value));
  }
}
...
class cd_StartArmorBonus : BasicArmorBonus
{
  ...
  {
    // warning: hardcoded category and option name.
    savePercent = int(CD_EventHandler.getInstance()
          .getSetting("advancedgameplay:startarmorsavepercent"));
  }
}
#+end_src
