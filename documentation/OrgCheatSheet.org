# Lines starting with # are comments, they aren't exported to HTML.
...
*bold* _underlined_ ~monospace~ +strike-through+ /italics/ */_+combined+_/*.
...
(org-file-contents "OrgCheatSheet.org")
#+end_src
