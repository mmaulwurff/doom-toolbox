...
section in the Readme for how to extract source files from .org files. See [[file:OrgCheatSheet.org][Org Cheat
Sheet]] for Org mode syntax.

* Pros

** Logical code structure

You can put related program components together, even if they're in different
...
Export to HTML produces a formatted document. Also, GitHub shows .org
files as a formatted HTML page, though macros and ~:noexport:~ sections aren't
supported.
...
The best text editor choice for Org files is Emacs. Some other text editors have
plugins with varying level of support.
...
spend time formatting Org. See [[file:OrgCheatSheet.org][Org cheat sheet]].

** Compilation error reporting

The compiler reports errors and warnings with line numbers of the extracted files,
not line numbers in the Org file.

** Licensing mess

If you want apply different licenses to project source files and documentation,
