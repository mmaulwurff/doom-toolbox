...
class hi_EventHandler : StaticEventHandler
{
  ...
  override void worldThingSpawned(WorldEvent event)
  {
    ...
    if (thing)
    {
      if (thing.bMissile && thing.damage)
        ...
        spawnDebris(thing.damageSource, thing, 1);
    }
  }
  ...
  private void spawnDebris(Actor source, Actor impact, double intensity)
  {
    ...
    mParticleParameters.texture  = traceData.hitTexture;
    ...
    mParticleParameters.pos      = traceData.hitLocation;
  ...
  // TODO: improve 3D floors support.
