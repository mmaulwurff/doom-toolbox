...
OptionMenu sts_Menu
{
  ...
  StaticText  "Position"
  Slider      "Horizontal", sts_x_position, 0.0, 1.0, 0.01, 2
  Slider      "Vertical",   sts_y_position, 0.0, 1.0, 0.01, 2
  ...
  StaticText  ""
  Option      "On automap", sts_on_automap, OnOff

  StaticText  ""
  StaticText  "Colors"
  ColorPicker "Base",   sts_color_base
  ColorPicker "Noise",  sts_color_noise
  ColorPicker "Level",  sts_color_geometry
  ColorPicker "Danger", sts_color_danger
}
...
[enu default]
STS_MENU_NAME  = "SoundToScreen \cj⚞\c-";

[ru]
STS_DANGER = "Опасность";
#+end_src
...
#include "zscript/sts_PlainTranslator.zs"
