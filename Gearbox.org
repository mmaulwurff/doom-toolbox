...
class gb_WeaponMenu
{
  ...
  private
  void rotate(int oldIndex, int newIndex)
  {
  ...
  private
  bool, int findIndexOfNextWeaponWithSlot(int weaponIndex, int slot)
  {
    int nWeapons = mWeapons.size();
  ...
  bool isHidden(string className) const
  {
    ...
    int nServices = mHideServices.size();
  ...
  TextureID getIconFor(Weapon aWeapon) const
  {
    ...
    {
      int nServices = mIconServices.size();
  ...
  /**
   ...
   ,*/
  private ui
  int findWeapon(int direction) const
  {
    int nWeapons = mWeapons.size();
  ...
  private
  int getIndexOf(class<Weapon> aClass) const
  {
    int nWeapons = mWeapons.size();
    for (int i = 0; i < nWeapons; ++i)
    {
...
{
  static
  bool isValid(int ammo, int maxAmmo)
  {
...
class gb_WheelIndexer
{
  ...
  private
  void reportInnerIndex( int nPlaces
                       , gb_WheelControllerModel controllerModel
                       , gb_MultiWheelModel      multiWheelModel
                       , gb_ViewModel            viewModel
                       )
  ...
  private static
  double itemAngle(int nItems, int index)
  {
...
{
  static
  int getSelectedIndex(int nItems, gb_WheelControllerModel controllerModel, gb_Screen screen)
  {
...
class gb_MultiWheel
{
  ...
  static
  bool isSingleWeaponInSlot(gb_ViewModel viewModel, int nWeapons, int slot)
  {
    int nWeaponsInSlot = 0;
    for (int i = 0; i < nWeapons; ++i)
    {
...
class gb_WheelView
{
  ...
  private
  void drawAmmo(double weaponAngle, vector2 center, gb_ViewModel viewModel, int weaponIndex)
  {
  ...
  private
  void displaySlot(int place, int slot, int nPlaces, int radius)
  {
  ...
  private
  void drawHands(int nPlaces, int selectedIndex, vector2 center, double startAngle)
  {
    if (nPlaces < 2) return;
